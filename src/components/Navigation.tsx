...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="fixed top-0 w-full z-50 py-4 px-6 md:px-12 flex justify-between items-center text-gold bg-burgundy/80 backdrop-blur-md border-b border-gold/10">
