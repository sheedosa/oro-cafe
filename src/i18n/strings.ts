...
const en = {
  ...
  gallery: {
    ...
    // Category-tile labels (one per item in `site.categories`, same order).
    categoriesEyebrow: 'Browse the Menu',
    categories: [
      'Hot Drinks',
      'Iced Coffee',
      'Milkshakes',
    ...
    // Product-carousel labels (one per item in `site.gallery`, same order).
    galleryEyebrow: 'On the Menu',
    labels: [
      'Honey Croissant',
      'Waffle Stick',
      'Pistachio Crepe',
...
const ar: typeof en = {
  ...
  gallery: {
    ...
    categoriesEyebrow: 'تصفّح القائمة',
    categories: [
      'مشروبات ساخنة',
      'قهوة باردة',
      'ميلك شيك',
